...
def index_update_single_project_collection_metadata(ctx, project_id, collection_id, es=None):
    """
    ...
    try:
        es.delete(index=COLLECTION_METADATA_INDEX, id=project_id + "_" + collection_id)
