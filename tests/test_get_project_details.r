# Call with
#
# irule -r irods_rule_engine_plugin-python-instance -F test_get_project_details.r "*project='/nlmumc/projects/P000000010'" "*show_service_accounts='true'" | python -m json.tool
