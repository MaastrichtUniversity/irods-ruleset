# Call with
#
# irule -r irods_rule_engine_plugin-python-instance -F test_get_project_collection_tape_estimate.r "*project='P000000010'" "*collection='C000000001'" | python -m json.tool
