# Call with
#
# irule -r irods_rule_engine_plugin-python-instance -F test_create_new_project.r "*authorizationPeriodEndDate='1-1-2018'" "*dataRetentionPeriodEndDate='1-1-2018'" "*ingestResource='iresResource'" "*resource='replRescUM01'" "*storageQuotaGb='10'" "*title='Testing'" "*principalInvestigator='p.rofessor@maastrichtuniversity.nl'" "*dataSteward='d.steward@maastrichtuniversity.nl'" "*respCostCenter='UM-30001234X'" "*openAccess='false'" "*tapeArchive='true'"
...
def main(rule_args, callback, rei):
    ...
    output = callback.create_new_project(authorizationPeriodEndDate, dataRetentionPeriodEndDate,
                                                   ...
                                                   respCostCenter, openAccess, tapeArchive, "result")

    callback.writeLine("stdout", output["arguments"][11])
