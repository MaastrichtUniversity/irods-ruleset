# Call with
#
# irule -r irods_rule_engine_plugin-python-instance -F test_list_project_viewers.r "*project_id='P000000010'" "*inherited='true'" "*show_service_accounts='true'" | python -m json.tool
