# Call with
# irule -r irods_rule_engine_plugin-irods_rule_language-instance -F /rules/native_irods_ruleset/misc/getResourceAVU.r "*resourceName='replRescUM01'" "*attribute='NCIT:C88193'" "*overrideValue=''" "*fatal='true'"
#
