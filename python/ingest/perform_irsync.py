...
def perform_irsync(ctx, destination_resource, token, destination_collection):
    ...
    It takes care of actually copying (syncing) the content of the physical drop-zone path into the destination collection.
    ...
    destination_resource: str
        The resource that the ingest should end up in; e.g. 'replRescUM01'
    token: str
