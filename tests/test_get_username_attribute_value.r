# Call with
#
# irule -r irods_rule_engine_plugin-python-instance -F /rules/tests/test_get_username_attribute_value.r "*username='jmelius'" "*attribute='voPersonExternalID'" | python -m json.tool
