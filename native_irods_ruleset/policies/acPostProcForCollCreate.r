...
acPostProcForCollCreate {
    ...
    ### Policy to increment the value of the 'latestProjectCollectionNumber' AVU on /nlmumc/projects/PXXXXXXXXX
    if ($collName like regex "/nlmumc/projects/P[0-9]{9}/C[0-9]{9}") {
        *latest = 0;
        ...
        msiAddKeyVal(*latestProjectNumberAVU, "latestProjectCollectionNumber", str(*latest));
