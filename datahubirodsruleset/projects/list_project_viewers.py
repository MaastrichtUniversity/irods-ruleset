...
def list_project_viewers(ctx, project_id, inherited, show_service_accounts):
    ...
    inherited : str
        ...
        * inherited='false' only shows explicit viewers. i.e. A viewer only has READ access
    ...
    for result in row_iterator(
        "COLL_ACCESS_USER_ID",
        f"COLL_ACCESS_NAME in ({criteria}) AND " + f"COLL_NAME = '/nlmumc/projects/{project_id}'",
        AS_LIST,
        ctx.callback,
    ):
