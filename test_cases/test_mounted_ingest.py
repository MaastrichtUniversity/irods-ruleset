...
class BaseTestCaseMountedIngest(BaseTestCaseIngest):
    ...
    def add_data_to_dropzone(cls):
        ...
        rule = "irule -r irods_rule_engine_plugin-python-instance -F /rules/utils/createFakeFiles.r '*dropzonePath=\"/mnt/ingest/zones/{}\"' '*remoteResource=\"{}\"'".format(cls.token, remote_resource)
