...
IRULE_detailsProjectCollection(*project, *collection, *inherited, *result) {
    ...
    *details = '{"project": "*project", "collection": "*collection", "enableOpenAccessExport": "*enableOpenAccessExport", "enableArchive": "*enableArchive", "creator": "*creator", "numFiles": "*numFiles", "PID": "*PID", "byteSize": *byteSize, "managers": *managers, "contributors": *contributors, "viewers": *viewers}';
