# Call with
#
# irule -r irods_rule_engine_plugin-python-instance -F /rules/tests/test_list_project_viewers.r "*project_id='P000000010'" "*inherited='true'" "*show_service_accounts='true'" | python -m json.tool
...
def main(rule_args, callback, rei):
    ...
    output = callback.list_project_viewers(project_id, inherited, show_service_accounts, '')
