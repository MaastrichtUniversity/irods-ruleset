# Call with
#
# irule -r irods_rule_engine_plugin-python-instance -F /rules/tests/test_list_project_managers.r "*project_id='P000000010'" "*show_service_accounts='true'" | python -m json.tool
...
def main(rule_args, callback, rei):
    ...
    output = callback.list_project_managers(project_id, show_service_accounts, '')
